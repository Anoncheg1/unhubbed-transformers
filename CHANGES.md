* base
[[file:~/proj/proj-pers-ai/UNHUBBED-transformers.org::*update code][update code]]
* old
...
* new
** NameError: name 'hf_hub_utils' is not defined
- utils/logging.py
  - _tqdm_active = True
- trainer.py

** cannot import name 'HF_MODULES_CACHE' from 'transformers.utils ????????
comment import of: in dynamic_module_utils.py::38
- HF_MODULES_CACHE
- TRANSFORMERS_DYNAMIC_MODULE_NAME,
...
** OLD                    - “ModuleNotFoundError: No module named 'transformers.utils.constants'”

file: unhubbed-transformers/src/transformers/utils/hub.py
#+NAME "replacement for huggingface_hub.constants"
#+begin_src python :results none :exports code :eval no
import re
...
create file unhubbed-transformers/src/transformers/utils/constants.py
#+begin_src python :results none :exports code :eval no
...
#+end_src
** ImportError: cannot import name 'CHAT_TEMPLATE_DIR'
*** in tokenization_utils_base.py
sync with utils/__init__.py
#+begin_src python :results none :exports code :eval no
from .utils import (
    # CHAT_TEMPLATE_DIR,
    # CHAT_TEMPLATE_FILE,
...
#+end_src
** NameError: name 'PushToHubMixin' is not defined.
grep -Rin PushToHubMixin
*** tokenization_utils_base.py
- remove PushToHubMixin from class PreTrainedTokenizerBase(SpecialTokensMixin, PushToHubMixin):
  - class PreTrainedTokenizerBase(SpecialTokensMixin): # PushToHubMixin
*** configuration_utils.py
comment at from .utils import (
# PushToHubMixin,
# download_url

from class PretrainedConfig(PushToHubMixin):
- remove PushToHubMixin
** ImportError: cannot import name 'AddedToken' from 'transformers' (/home/g/proj/proj-pers-ai/transformers/__init__.py)
*where happen*:
...
solution: add “from transformers.tokenization_utils_base import AddedToken”  to your file
** ImportError: cannot import name 'OptionalDependencyNotAvailable' from partially initialized module 'transformers.utils' (most likely due to a circular import) (/home/tmp/proj-pers-ai/transformers/utils/__init__.py)

Traceback (most recent call last):
  File "/home/g/proj/proj-pers-ai/transformers-test.py", line 10, in <module>
    from transformers.models.auto.tokenization_auto import AutoTokenizer
  File "/home/g/proj/proj-pers-ai/transformers/__init__.py", line 28, in <module>
    from .utils import (
  File "/home/g/proj/proj-pers-ai/transformers/utils/__init__.py", line 114, in <module>
    from .backbone_utils import BackboneConfigMixin, BackboneMixin
  File "/home/g/proj/proj-pers-ai/transformers/utils/backbone_utils.py", line 24, in <module>
    from ..configuration_utils import PretrainedConfig
  File "/home/g/proj/proj-pers-ai/transformers/configuration_utils.py", line 27, in <module>
    from .modeling_gguf_pytorch_utils import load_gguf_checkpoint
  File "/home/g/proj/proj-pers-ai/transformers/modeling_gguf_pytorch_utils.py", line 22, in <module>
    from .integrations import (
  File "/home/g/proj/proj-pers-ai/transformers/integrations/__init__.py", line 16, in <module>
    from ..utils import OptionalDependencyNotAvailable, _LazyModule, is_torch_available, is_torch_greater_or_equal
ImportError: cannot import name 'OptionalDependencyNotAvailable' from partially initialized module 'transformers.utils' (most likely due to a circular import) (/home/g/proj/proj-pers-ai/transformers/utils/__init__.py)


Solutuion:


in transformers/__init__.py there is “if not TYPE_CHECKING:”


-- OptionalDependencyNotAvailable --

transformers.utils -> integrations/__init__.py
*where happen*:
- in integrations/__init__.py", line 16

*from where import*:
- utils/__init__.py

*where target* OptionalDependencyNotAvailable
- ..utils/__init.py


The utils module is trying to import something from integrations,
 which in turn is trying to import something from utils before utils
...
Solution:
move “from .backbone_utils import BackboneConfigMixin, BackboneMixin” after “OptionalDependencyNotAvailable”





**  has no attribute 'push_to_hub'
grep -Rin "push_to_hub = copy_func"

also sync with utils/__init__.py
*** AttributeError: type object 'PreTrainedTokenizerBase' in tokenization_utils_base.py::4151
comment
#+begin_src
...
#+end_src
*** AttributeError: type object 'PretrainedConfig' in configuration_utils.py", line 1207
comment lines
*** modeling_utils.py
** ImportError: cannot import name 'PushToHubMixin'
grep -Rin PushToHubMixin

sync with utils/__init__.py
** ModuleNotFoundError: Could not import module 'BertModel'. Are this object's requirements defined correctly?
** ImportError: cannot import name 'AutoTokenizer' from 'transformers' (/home/g/proj/proj-pers-ai/transformers/__init__.py)
from ..models.auto.tokenization_auto import TOKENIZER_MAPPING_NAMES, AutoTokenizer
** ImportError: cannot import name 'cached_file' from partially initialized module 'transformers.utils' and from .backbone_utils import BackboneConfigMixin, BackboneMixin
solution move “from .backbone_utils import BackboneConfigMixin, BackboneMixin” after import cached_file'
** ImportError: cannot import name 'Environment' from partially initialized module 'jinja2.environment' (most likely due to a circular import) (/usr/lib/python3.12/site-packages/jinja2/environment.py)
Error in Jinja2 itself
we just disable jinja2 for now

in transformers/utils/chat_template_utils.py
** ModuleNotFoundError: No module named 'torch._C._distributed_c10d'; 'torch._C' is not a package
comment in transformers/modeling_utils.py", line 40, in <module>
